<section>
    ...
    <form method="post" action="{{ route('jobs.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('post')
        ...
        <div>
            ...
            <x-text-input id="type" name="type" type="text" class="mt-1 block w-full" required autofocus />
