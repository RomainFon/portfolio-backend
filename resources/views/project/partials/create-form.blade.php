<section>
    ...
    <form method="post" action="{{ route('projects.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('post')
        ...
        <div>
            <x-input-label for="technologies-select" :value="__('Technologies')" />
            <x-select-multiple-input id="technologies" class="mt-1 block w-full" :ressources="$technologies" data-name="technologies[]"/>
