<section>
    ...
    <form method="post" action="{{ route('technologies.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        @csrf
        @method('post')
        ...
        <div>
            ...
            <x-text-input id="top" name="top" type="checkbox" class="mt-1 block w-6 h-6" value="true" />
